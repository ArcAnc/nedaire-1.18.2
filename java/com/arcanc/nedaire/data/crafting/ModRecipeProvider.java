...
public class ModRecipeProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> out) 
	{
		...
		save(out, StringHelper.getLocFStr(ModDatabase.Recipes.VanillaTypes.CONVERSION + "/" + mat.getNugget().get().getRegistryName().getPath() + "_to_" + mat.getIngot().get().getRegistryName().getPath()));
		...
		save(out, StringHelper.getLocFStr(ModDatabase.Recipes.VanillaTypes.CONVERSION + "/" + mat.getIngot().get().getRegistryName().getPath() + "_to_" + mat.getNugget().get().getRegistryName().getPath()));
		...
		pattern("AAA").
		unlockedBy("has_" + ModDatabase.Items.Names.INGOT +"_" + mat.getName(), has(ModTags.Items.MATERIALS.get(mat.getName()).getIngot())).
		save(out, StringHelper.getLocFStr(ModDatabase.Recipes.VanillaTypes.CONVERSION + "/" + mat.getIngot().get().getRegistryName().getPath() + "_to_" + mat.getStorageBlock().get().getRegistryName().getPath()));
		...
		save(out, StringHelper.getLocFStr(ModDatabase.Recipes.VanillaTypes.CONVERSION + "/" + mat.getStorageBlock().get().getRegistryName().getPath() + "_to_" + mat.getIngot().get().getRegistryName().getPath()));
		...
		if (mat.requiredOre())
		{
			...
			save(out, StringHelper.getLocFStr(ModDatabase.Recipes.VanillaTypes.CONVERSION + "/" + mat.getRaw().get().getRegistryName().getPath() + "_to_" + mat.getRawStorageBlock().get().getRegistryName().getPath()));
			...
			save(out, StringHelper.getLocFStr(ModDatabase.Recipes.VanillaTypes.CONVERSION + "/" + mat.getRawStorageBlock().get().getRegistryName().getPath() + "_to_" + mat.getRaw().get().getRegistryName().getPath()));
		}
	...
	{	
		...
		save(out, StringHelper.getLocFStr(ModDatabase.Recipes.VanillaTypes.BLASTING + "/" + input.location().getPath() + "_to_" + output.getRegistryName().getPath()));
	}
	...
	private void addSmelting (TagKey<Item> input, Item output, float exp, Consumer<FinishedRecipe> out)
	{
		...
		unlockedBy("has_" + input.location().getPath(), has(input)).
		save(out, StringHelper.getLocFStr(ModDatabase.Recipes.VanillaTypes.SMELTING + "/" + input.location().getPath() + "_to_" + output.getRegistryName().getPath()));
	}
	...
	private void addWeapon(ModMaterial mat, Consumer<FinishedRecipe> out)
	{
		...
		unlockedBy("has_" + Tags.Items.STRING.location().getPath(), has(Tags.Items.STRING)).
		unlockedBy("has_" + Tags.Items.RODS_WOODEN.location().getPath(), has(Tags.Items.RODS_WOODEN)).
		unlockedBy("has_" + net.minecraft.world.item.Items.TRIPWIRE_HOOK.getRegistryName().getPath(), has(net.minecraft.world.item.Items.TRIPWIRE_HOOK)).
	...
	{
		SpecialRecipeBuilder.special(serializer).save(out, StringHelper.getStrLocFStr("dynamic/" + serializer.getRegistryName().getPath()));
	}
